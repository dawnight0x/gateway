...
`background`、`previous_response_id`、`conversation`、`include`、`max_tool_calls`、内置工具和其他 Responses 独有能力只能使用原生 Responses 上游。Chat 的 `n > 1`、音频、logprobs、prediction 等独有能力也不会回退到 Responses。
